...
{
    var objRef, os, rand_key, roomList, buddyList, buddyVars, activeRoomId, myUserId, myUserName, playerId, debug, isConnected, changingRoom, amIModerator, arrayTags, messageHandlers, onConnect, onData, onXML, onClose, onBuddyList, t1, ipAddress, onConnection, onConnectionLost, close;
    ...
    function connect(serverIp, serverPort)
    {
        ...
        {
            ipAddress = serverIp;
            super.connect("127.0.0.1", serverPort);
        }
        else
        {
